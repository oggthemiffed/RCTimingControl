...
- [X] **[AUDIO-08/13]** Go to **Racer Profile → "Announcement Voice"** section
...
- [X] **[AUDIO-14]** Go to **Admin → Audio Settings → Profanity Blocklist**
...
- [X] **[AUDIO-07]** Go to **Admin → Audio Settings**
...
- [X] **[AUDIO-11]** Go to **Race Control → CockpitPage → Audio Settings panel** (sidebar)
...
- [X] **[AUDIO-04]** With a race RUNNING and transponders crossing:
...
- [X] **[AUDIO-06]** With a race RUNNING:
...
- [X] **[AUDIO-02/AUDIO-05]** Transition a race to **GRID**:
...
- [X] **[AUDIO-03]** In stagger mode, when race director calls running order:
...
- [X] **[PRACTICE-01]** Navigate to **Race Control → Practice**
...
- [X] **[PRACTICE-01]** Click **Start** → session transitions to RUNNING
...
- [X] **[AUDIO-15]** Go to **Admin → Racers → [any racer]**
